...
<title>Trailhead — Unsubscribe</title>
<style>
  body{{background:#0d1117;color:#c9d1d9;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;
       display:flex;align-items:center;justify-content:center;height:100vh;margin:0;}}
  .box{{text-align:center;max-width:420px;padding:0 20px;}}
  .brand{{color:#52b788;font-family:monospace;font-size:1.6em;font-weight:700;margin-bottom:20px;}}
  p{{color:#8b949e;line-height:1.6;}}
</style></head>
<body><div class="box">
<div class="brand">Trailhead</div>
<p>{message}</p>
</div></body></html>"""
...
async def unsubscribe(request: Request, token: str):
    ...
    if sub and sub.get("active"):
        ...
        message = "You've been unsubscribed from Trailhead and will no longer receive emails."
    elif sub:
        message = "You're already unsubscribed from Trailhead."
    else:
